...
class AuthProvider{
    ...
    func Login(Email: String, Password: String, loginHandler: LoginHandler?){
        Auth.auth().signIn(withEmail: Email, password: Password) { (user, error) in
            ...
            {
                DBProvider.Instance.rider_id = (user?.uid)!;
                loginHandler?(nil)
            }
        }
    }
    ...
    func ChangePass (Password: String) -> String
    {
    ...
    func Signup(Fname: String, Lname: String, PhoneNumber: String, Email: String, Password: String, BankNum: String, loginHandler: LoginHandler?)
    {
        Auth.auth().createUser(withEmail: Email, password: Password) { (user, error) in
            ...
            else
            {
                if user?.uid != nil
                {
                    ...
                    DBProvider.Instance.SaveUser(Fname: Fname, Lname: Lname, PNumber: PhoneNumber, ID: (user?.uid)!, Email: Email, Password: Password, CCN: BankNum)
